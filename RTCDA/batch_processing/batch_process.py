...
if __name__ == "__main__":
    ...
    sqlDF = spark.sql("SELECT prev_title as source, curr_title as topic, count(*) as count FROM wiki GROUP BY prev_title, curr_title ORDER BY count DESC LIMIT 1000")
    sqlDF.show()
